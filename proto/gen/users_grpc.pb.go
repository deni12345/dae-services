...
const (
	...
	UsersService_LinkExternalIdentity_FullMethodName = "/core.v1.UsersService/LinkExternalIdentity"
...
type UsersServiceClient interface {
	...
	// Admin only
	AdminSetUserRoles(ctx context.Context, in *AdminSetUserRolesRequest, opts ...grpc.CallOption) (*AdminSetUserRolesResponse, error)
}
...
func (c *usersServiceClient) LinkExternalIdentity(ctx context.Context, in *LinkExternalIdentityRequest, opts ...grpc.CallOption) (*LinkExternalIdentityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LinkExternalIdentityResponse)
	err := c.cc.Invoke(ctx, UsersService_LinkExternalIdentity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersServiceClient) AdminSetUserRoles(ctx context.Context, in *AdminSetUserRolesRequest, opts ...grpc.CallOption) (*AdminSetUserRolesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminSetUserRolesResponse)
...
type UsersServiceServer interface {
	...
	// Admin only
	AdminSetUserRoles(context.Context, *AdminSetUserRolesRequest) (*AdminSetUserRolesResponse, error)
...
func (UnimplementedUsersServiceServer) LinkExternalIdentity(context.Context, *LinkExternalIdentityRequest) (*LinkExternalIdentityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LinkExternalIdentity not implemented")
}
func (UnimplementedUsersServiceServer) AdminSetUserRoles(context.Context, *AdminSetUserRolesRequest) (*AdminSetUserRolesResponse, error) {
...
func _UsersService_LinkExternalIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LinkExternalIdentityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServiceServer).LinkExternalIdentity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UsersService_LinkExternalIdentity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).LinkExternalIdentity(ctx, req.(*LinkExternalIdentityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UsersService_AdminSetUserRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminSetUserRolesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).AdminSetUserRoles(ctx, req.(*AdminSetUserRolesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UsersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UsersService_LinkExternalIdentity_Handler,
		},
		{
